...
describe("Conjured Item Tests -- Gilded Rose", () => {
  it("should reduce quality of conjured item by 2", () => {
    const gildedRose = new Shop([new Item("Conjured Item", 4, 5)]);
    const items = gildedRose.updateQuality();
    expect(items[0].quality).toEqual(3);
  });
  it("should reduce quality of conjured item by 1 if too low", () => {
    const gildedRose = new Shop([new Item("Conjured Item", 4, 1)]);
    const items = gildedRose.updateQuality();
    expect(items[0].quality).toEqual(0);
  });
  it("should reduce quality of item by 4 after sellIn", () => {
...
describe("Discount Item Tests -- Gilded Rose", () => {
  let gildedRose;
  beforeEach(() => {
    gildedRose = new Shop([
  ...
  it("should add items to discount once Quality reaches 0", () => {
  ...
  it("should add item to Discount once SellIn date passes", () => {
    gildedRose.updateQuality();
    gildedRose.updateQuality();
    gildedRose.updateItemLists();
    const discountItems = gildedRose.getDiscounted();
  ...
  it("should decrease quality of discounted item twice as fast", () => {
    gildedRose.updateQuality();
    gildedRose.updateQuality();
    gildedRose.updateItemLists();
    const discountItems = gildedRose.getDiscounted();
...
describe("OnSale Item Tests -- Gilded Rose", () => {
  let gildedRose;
  beforeEach(() => {
    gildedRose = new Shop([
      new Item("ESP32", 8, 6),
  ...
  it("should keep items in onSale if quality > 0 and SellIn date not passed", () => {
    gildedRose.updateQuality();
    gildedRose.updateItemLists();
    const onSaleItems = gildedRose.getOnSale();
    expect(onSaleItems.length).toEqual(3);
  });
  it("should remove item from onSale once SellIn date passes", () => {
    gildedRose.updateQuality();
    gildedRose.updateQuality();
    gildedRose.updateItemLists();
    const onSaleItems = gildedRose.getOnSale();
...
describe("Sulfuras Item Tests -- Gilded Rose", () => {
  let gildedRose;
  beforeEach(() => {
    gildedRose = new Shop([new Item("Sulfuras, Hand of Ragnaros", 1000, 80)]);
  });
  it("should not reduce the quality of Sulfuras item", () => {
    const items = gildedRose.updateQuality();
    expect(items[0].quality).toEqual(80);
  });
  it("should not change SellIn date of Sulfuras item", () => {
    const items = gildedRose.updateQuality();
    expect(items[0].sellIn).toEqual(1000);
  });
});

describe("Backstage Passes Item Tests -- Gilded Rose", () => {
  it("should increase the quality of Backstage pass item by 1", () => {
  ...
  it("should increase the quality of Backstage pass item by 2", () => {
    const gildedRose = new Shop([
  ...
  it("should increase the quality of Backstage pass item by 3", () => {
    const gildedRose = new Shop([
  ...
  it("should drop the quality of Backstage pass item to 0", () => {
    const gildedRose = new Shop([
  ...
  it("should not let quality of Backstage pass item go below 0", () => {
    const gildedRose = new Shop([
...
describe("Aged Brie Item Tests -- Gilded Rose", () => {
  it("should increase quality of Brie by 1 before SellIn", () => {
    const gildedRose = new Shop([new Item("Aged Brie", 3, 4)]);
    const items = gildedRose.updateQuality();
    expect(items[0].quality).toEqual(5);
  });
  it("should increase quality of Brie by 2 after SellIn", () => {
    const gildedRose = new Shop([new Item("Aged Brie", 0, 5)]);
    const items = gildedRose.updateQuality();
    expect(items[0].quality).toEqual(7);
  });
  it("should not increase quality of Brie beyond 50", () => {
  ...
  describe("Boring Item Tests -- Gilded Rose", () => {
    ...
    it("should decrease quality by 1 each day while On Sale", () => {
